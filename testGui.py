...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.file.setStyleSheet("background-color:rgb(0,0,0)")
        self.file.setStyleSheet(
            "QPushButton{background-color:rgb(111,180,219)}"  # 按键背景色
            "QPushButton:hover{color:green}"  # 光标移动到按钮上面后的前景色
            "QPushButton{border-radius:10px}"  # 圆角半径
            "QPushButton:pressed{background-color:rgb(125,200,200);border: None;}"  # 按下时的样式
        )
